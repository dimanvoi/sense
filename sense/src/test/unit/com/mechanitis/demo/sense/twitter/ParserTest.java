...
public class ParserTest {
    ...
    void testGetMessageContent() {
        ...
        String tweetContent = Parser.getValueForField(fieldName, EXAMPLE_INPUT);
    ...
    void testGetUsernameContent() {
        ...
        assertEquals("trisha_gee", tweetContent);
    }
    ...
    public void shouldWorkWellInAMap() {
        ...
        List<String> userMessages = messages.map((message) -> Parser.getValueForField(message, "\"screen_name\":\""))
...
//    }
    ...
    private static final String EXAMPLE_INPUT = "tweet = {\"created_at\":\"Tue Jan 27 12:37:11 +0000 2015\"," +
                                                ...
                                                "\"user\":{\"id\":36075321,\"id_str\":\"36075321\",\"name\":\"Toni " +
                                                "Alexander\"," +
                                                "\"screen_name\":\"trisha_gee\"," +
                                                "\"location\":\"ATL, GA\",\"url\":null,\"description\":\"I'm a laid " +
                                                "back chick who loves to have fun\",\"protected\":false," +
                                                "\"verified\":false," +
                                                "\"followers_count\":41,\"friends_count\":118,\"listed_count\":1," +
                                                "\"favourites_count\":5,\"statuses_count\":2555,\"created_at\":\"Tue " +
                                                "Apr 28 14:17:20 +0000 2009\"," +
                                                "\"utc_offset\":-18000,\"time_zone\":\"Eastern Time (US & Canada)\"," +
                                                "\"geo_enabled\":false,\"lang\":\"en\"," +
                                                "\"contributors_enabled\":false,\"is_translator\":false," +
                                                "\"profile_background_color\":\"FF6699\"," +
                                                "\"profile_background_image_url\":\"http:\\/\\/abs.twimg" +
                                                ".com\\/images\\/themes\\/theme11\\/bg.gif\"," +
                                                ...
                                                "\"entities\":{\"hashtags\":[],\"trends\":[]," +
                                                "\"urls\":[{\"url\":\"http:\\/\\/t.co\\/cRS9M0bneh\"," +
                                                "\"expanded_url\":\"http:\\/\\/bit.ly\\/yibOac\"," +
                                                "\"display_url\":\"bit.ly\\/yibOac\",\"indices\":[87,109]}]," +
                                                "\"user_mentions\":[],\"symbols\":[]},\"favorited\":false," +
                                                "\"retweeted\":false,\"possibly_sensitive\":false," +
                                                "\"filter_level\":\"low\",\"lang\":\"en\"," +
                                                "\"timestamp_ms\":\"1422362231657\"}";
